...
public class Jailer extends AppCompatActivity {
    int date=0,cinema=0;
    TextView t3,t4;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_jailer);
        ...
        Button11.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if(date==0 || cinema==0) {
                    Toast.makeText(Jailer.this, "Select Date And Time", Toast.LENGTH_SHORT).show();
                }else{
                    Intent in = new Intent(Jailer.this, Seats.class);
                    startActivity(in);
                }
            }
        });
