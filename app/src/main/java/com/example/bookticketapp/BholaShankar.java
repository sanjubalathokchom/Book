...
public class BholaShankar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bhola_shankar);
        ...
        Button11.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if(date==0 || cinema==0) {
                    Toast.makeText(BholaShankar.this, "Select Date And Time", Toast.LENGTH_SHORT).show();
                }else{
                    Intent in = new Intent(BholaShankar.this, Seats.class);
                    startActivity(in);
                }
            }
        });
