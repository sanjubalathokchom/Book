...
public class Jawan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jawan);
        ...
        Button11.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if(date==0 || cinema==0) {
                    Toast.makeText(Jawan.this, "Select Date And Time", Toast.LENGTH_SHORT).show();
                }else{
                    Intent in = new Intent(Jawan.this, Seats.class);
                    startActivity(in);
                }
            }
        });
